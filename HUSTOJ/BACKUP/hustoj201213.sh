...
#how to make src zip
#zip -r hustoj201213.zip ./src
wget https://raw.githubusercontent.com/melongist/CSL/master/HUSTOJ/hustoj201213.zip
unzip hustoj201213.zip

#------ original intallation scripts 2020.12.13 start
...
#------ original intallation scripts 2020.12.13 end
