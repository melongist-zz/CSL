...
wget https://raw.githubusercontent.com/melongist/CSL/master/HUSTOJ/hustoj210107.zip
unzip hustoj210107.zip

#------ original intallation scripts 2021.01.07 start
...
#------ original intallation scripts 2021.01.07 end
