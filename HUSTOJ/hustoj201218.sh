#!/bin/bash
#script made by melongist(what_is_computer@msn.com)
#for Korean

if [[ -z $SUDO_USER ]] ; then
  echo "Use 'sudo bash hustoj201213.sh'"
  exit 1
fi
...
wget https://raw.githubusercontent.com/melongist/CSL/master/HUSTOJ/hustoj201218.zip
unzip hustoj201218.zip

#------ original intallation scripts 2020.12.18 start
...
#------ original intallation scripts 2020.12.18 end
cd
