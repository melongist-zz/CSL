...
if [[ -z $SUDO_USER ]] ; then
  echo "Use 'sudo bash hustoj201230.sh'"
  exit 1
fi
...
#how to make src zip
#zip -r hustoj201230.zip ./src
wget https://raw.githubusercontent.com/melongist/CSL/master/HUSTOJ/hustoj201230.zip
unzip hustoj201230.zip

#------ original intallation scripts 2020.12.30 start
...
#------ original intallation scripts 2020.12.30 end
cd
