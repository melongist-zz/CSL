...
if [[ -z $SUDO_USER ]] ; then
  echo "Use 'sudo bash hustoj210101.sh'"
  exit 1
fi
...
#how to make src zip
#zip -r hustoj210101.zip ./src
wget https://raw.githubusercontent.com/melongist/CSL/master/HUSTOJ/hustoj210101.zip
unzip hustoj210101.zip

#------ original intallation scripts 2021.01.01 start
...
#------ original intallation scripts 2021.01.01 end
cd
